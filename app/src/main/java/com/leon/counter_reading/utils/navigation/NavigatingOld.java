...
public class NavigatingOld extends AsyncTask<Activity, Void, Void> {
    ...
    public NavigatingOld(int position, String uuid, int possibleEmpty, String possibleEshterak,
